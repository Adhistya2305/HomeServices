                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{$slide->title}}</td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="#" onclick="confirm('apakah kamu yakin akan menghapus slide ini?') || event.stopImmediatePropagation()"  wire:click.prevent="deleteSlide({{$slide->id}})"  style="margin-left: 10px;"><i class="fa fa-times fa-2x text-danger"></i></a>
                                                        </td>
